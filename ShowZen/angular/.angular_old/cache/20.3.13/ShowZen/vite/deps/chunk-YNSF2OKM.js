...
_ContentProjectionService.ɵfac = function ContentProjectionService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ContentProjectionService)();
};
...
var SSR_FLAG = makeStateKey("SSR_FLAG");
var APP_STARTED_WITH_SSR = new InjectionToken("APP_STARTED_WITH_SSR", {
  providedIn: "root",
  factory: () => {
...
var _AbpCookieStorageService = class _AbpCookieStorageService {
  constructor() {
    this.platformId = inject(PLATFORM_ID);
  ...
  setCookie(name, value, opts) {
    let s2 = `${name}=${value}`;
    if (opts.path) s2 += `; Path=${opts.path}`;
    if (opts.domain) s2 += `; Domain=${opts.domain}`;
    if (opts.sameSite) s2 += `; SameSite=${opts.sameSite}`;
    if (opts.secure) s2 += `; Secure`;
    if (opts.expires) s2 += `; Expires=${opts.expires.toUTCString()}`;
    if (typeof opts["max-age"] === "number") s2 += `; Max-Age=${opts["max-age"]}`;
    this.document.cookie = s2;
  }
...
_AbpCookieStorageService.ɵfac = function AbpCookieStorageService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AbpCookieStorageService)();
};
_AbpCookieStorageService.ɵprov = ɵɵdefineInjectable({
  token: _AbpCookieStorageService,
  factory: _AbpCookieStorageService.ɵfac,
  providedIn: "root"
});
var AbpCookieStorageService = _AbpCookieStorageService;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AbpCookieStorageService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
_SessionStateService.ɵfac = function SessionStateService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _SessionStateService)();
};
...
_AbpTenantService.ɵfac = function AbpTenantService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AbpTenantService)();
};
...
_MultiTenancyService.ɵfac = function MultiTenancyService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MultiTenancyService)();
};
...
function getCurrentTenancyName(appBaseUrl, injector) {
  ...
  const tokenValue = isPlatformBrowser(platformId) ? parseTokens(document2.defaultView?.location.href)[token]?.[0] : void 0;
  return tokenValue;
}
function getCurrentTenancyNameFromUrl(tenantKey, injector) {
  ...
  const search = document2.defaultView?.location.search;
...
function getInitialData() {
  return __async(this, null, function* () {
    ...
    yield localeInitializer(injector);
  });
}
function localeInitializer(injector) {
  ...
  const {
    registerLocaleFn
  } = currentInjector.get(CORE_OPTIONS);
...
var ServerCookieParser = class _ServerCookieParser {
  ...
  static middleware() {
    return (req, res, next) => {
      req.cookies = _ServerCookieParser.parse(req.headers.cookie || "");
      next();
    };
  }
  static getCookie(req, name) {
    ...
    const cookies = _ServerCookieParser.parse(cookieHeader);
    return cookies[name];
  }
};
...
var _HtmlEncodingService = class _HtmlEncodingService {
  encode(value) {
    if (!value) {
      return value;
    }
...
_HtmlEncodingService.ɵfac = function HtmlEncodingService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _HtmlEncodingService)();
};
_HtmlEncodingService.ɵprov = ɵɵdefineInjectable({
  token: _HtmlEncodingService,
  factory: _HtmlEncodingService.ɵfac,
  providedIn: "root"
});
var HtmlEncodingService = _HtmlEncodingService;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HtmlEncodingService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
_HttpWaitService.ɵfac = function HttpWaitService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _HttpWaitService)();
};
...
_LazyLoadService.ɵfac = function LazyLoadService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _LazyLoadService)();
};
...
_ReplaceableComponentsService.ɵfac = function ReplaceableComponentsService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ReplaceableComponentsService)();
};
...
_RestService.ɵfac = function RestService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _RestService)();
};
...
_RouterWaitService.ɵfac = function RouterWaitService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _RouterWaitService)();
};
...
_AbstractNavTreeService.ɵfac = function AbstractNavTreeService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AbstractNavTreeService)();
};
...
var _DomStrategyService = class _DomStrategyService {
  constructor() {
    this.document = inject(DOCUMENT);
  }
  afterElement(el) {
...
_DomStrategyService.ɵfac = function DomStrategyService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _DomStrategyService)();
};
_DomStrategyService.ɵprov = ɵɵdefineInjectable({
  token: _DomStrategyService,
  factory: _DomStrategyService.ɵfac,
  providedIn: "root"
});
var DomStrategyService = _DomStrategyService;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DomStrategyService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
_AbpApplicationConfigurationService.ɵfac = function AbpApplicationConfigurationService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AbpApplicationConfigurationService)();
};
...
var _AbpApplicationLocalizationService = class _AbpApplicationLocalizationService {
  constructor() {
    this.restService = inject(RestService);
    this.apiName = "abp";
    this.get = (input2, config) => this.restService.request({
      method: "GET",
      url: "/api/abp/application-localization",
      params: {
        cultureName: input2.cultureName,
        onlyDynamics: input2.onlyDynamics
      }
    }, __spreadValues({
      apiName: this.apiName
    }, config));
...
_AbpApplicationLocalizationService.ɵfac = function AbpApplicationLocalizationService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AbpApplicationLocalizationService)();
};
...
_ConfigStateService.ɵfac = function ConfigStateService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ConfigStateService)();
};
...
var _LocalizationService = class _LocalizationService {
  ...
  constructor() {
    ...
    const otherInstance = inject(_LocalizationService, {
      optional: true,
      skipSelf: true
    });
...
function recursivelyMergeBaseResources(baseResourceName, source) {
  ...
  return item.baseResources.reduce((acc, baseResource) => {
    ...
    const texts = __spreadValues(__spreadValues({}, baseItem.texts), acc.texts);
...
var _DynamicLayoutComponent = class _DynamicLayoutComponent {
  constructor() {
    ...
    this.defaultLayout = input(void 0);
    this.router = inject(Router);
    ...
    this.routerEvents = inject(RouterEvents);
    this.environment = inject(EnvironmentService);
    const dynamicLayoutComponent = inject(_DynamicLayoutComponent, {
      optional: true,
      skipSelf: true
    });
  ...
  showLayoutNotFoundError(layoutName) {
    ...
    if (layoutName === "account") {
      message = 'Account layout not found. Please check your configuration. If you are using LeptonX, please make sure you have added "provideAccountLayout()" to your app configuration.';
    }
  ...
  listenToEnvironmentChange() {
    this.environment.createOnUpdateStream((x) => x.oAuthConfig).pipe(take(1), filter((config) => config.responseType === "code")).subscribe(() => {
      if (this.layout) {
        return;
      }
      this.getLayout();
...
_ReplaceableRouteContainerComponent.ɵfac = function ReplaceableRouteContainerComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ReplaceableRouteContainerComponent)();
};
...
_InputEventDebounceDirective.ɵfac = function InputEventDebounceDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _InputEventDebounceDirective)();
};
...
_ForDirective.ɵfac = function ForDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ForDirective)();
};
...
_FormSubmitDirective.ɵfac = function FormSubmitDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _FormSubmitDirective)();
};
...
_InitDirective.ɵfac = function InitDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _InitDirective)();
};
...
_ReplaceableTemplateDirective.ɵfac = function ReplaceableTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ReplaceableTemplateDirective)();
};
...
_StopPropagationDirective.ɵfac = function StopPropagationDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _StopPropagationDirective)();
};
...
_RoutesHandler.ɵfac = function RoutesHandler_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _RoutesHandler)();
};
...
var timezoneInterceptor = (req, next) => {
...
var transferStateInterceptor = (req, next) => {
...
function provideAbpCore(...features) {
  ...
  }), withFetch(), withInterceptors([transferStateInterceptor, timezoneInterceptor])), provideAppInitializer(() => __async(null, null, function* () {
    inject(LocalizationService);
    inject(LocalStorageListenerService);
    inject(RoutesHandler);
    yield getInitialData();
...
_LocalizationPipe.ɵfac = function LocalizationPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _LocalizationPipe)();
};
...
_ToInjectorPipe.ɵfac = function ToInjectorPipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ToInjectorPipe)();
};
...
var _ShortDatePipe = class _ShortDatePipe extends DatePipe {
  constructor() {
    ...
    const defaultTimezone = inject(DATE_PIPE_DEFAULT_TIMEZONE, {
      optional: true
    });
...
_ShortDatePipe.ɵfac = function ShortDatePipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ShortDatePipe)();
};
...
_ShortTimePipe.ɵfac = function ShortTimePipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ShortTimePipe)();
};
...
_ShortDateTimePipe.ɵfac = function ShortDateTimePipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ShortDateTimePipe)();
};
...
var _HtmlEncodePipe = class _HtmlEncodePipe {
  transform(value) {
    if (!value) {
      return value;
    }
...
_HtmlEncodePipe.ɵfac = function HtmlEncodePipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _HtmlEncodePipe)();
};
_HtmlEncodePipe.ɵpipe = ɵɵdefinePipe({
  name: "htmlEncode",
  type: _HtmlEncodePipe,
  pure: true
});
var HtmlEncodePipe = _HtmlEncodePipe;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HtmlEncodePipe, [{
    type: Pipe,
    args: [{
      name: "htmlEncode"
    }]
...
var CORE_DIRECTIVES = [AutofocusDirective, InputEventDebounceDirective, ForDirective, FormSubmitDirective, InitDirective, PermissionDirective, ReplaceableTemplateDirective, StopPropagationDirective];
var CORE_PIPES = [LocalizationPipe, SortPipe, SafeHtmlPipe, ShortDateTimePipe, ShortTimePipe, ShortDatePipe, ToInjectorPipe, UtcToLocalPipe, LazyLocalizationPipe];
var CORE_COMPONENTS = [DynamicLayoutComponent, ReplaceableRouteContainerComponent, RouterOutletComponent, AbstractNgModelComponent];
...
_BaseCoreModule.ɵmod = ɵɵdefineNgModule({
  ...
  imports: [CommonModule, FormsModule, ReactiveFormsModule, RouterModule, NgxValidateCoreModule, AutofocusDirective, InputEventDebounceDirective, ForDirective, FormSubmitDirective, InitDirective, PermissionDirective, ReplaceableTemplateDirective, StopPropagationDirective, LocalizationPipe, SortPipe, SafeHtmlPipe, ShortDateTimePipe, ShortTimePipe, ShortDatePipe, ToInjectorPipe, UtcToLocalPipe, LazyLocalizationPipe, DynamicLayoutComponent, ReplaceableRouteContainerComponent, RouterOutletComponent, AbstractNgModelComponent],
  exports: [CommonModule, FormsModule, ReactiveFormsModule, RouterModule, NgxValidateCoreModule, AutofocusDirective, InputEventDebounceDirective, ForDirective, FormSubmitDirective, InitDirective, PermissionDirective, ReplaceableTemplateDirective, StopPropagationDirective, LocalizationPipe, SortPipe, SafeHtmlPipe, ShortDateTimePipe, ShortTimePipe, ShortDatePipe, ToInjectorPipe, UtcToLocalPipe, LazyLocalizationPipe, DynamicLayoutComponent, ReplaceableRouteContainerComponent, RouterOutletComponent, AbstractNgModelComponent]
});
_BaseCoreModule.ɵinj = ɵɵdefineInjector({
  providers: [LocalizationPipe, provideHttpClient(withInterceptorsFromDi(), withFetch())],
  imports: [CommonModule, FormsModule, ReactiveFormsModule, RouterModule, NgxValidateCoreModule, CommonModule, FormsModule, ReactiveFormsModule, RouterModule, NgxValidateCoreModule]
});
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BaseCoreModule, [{
    type: NgModule,
    args: [{
      exports: [CommonModule, FormsModule, ReactiveFormsModule, RouterModule, NgxValidateCoreModule, ...CORE_DIRECTIVES, ...CORE_PIPES, ...CORE_COMPONENTS],
      imports: [CommonModule, FormsModule, ReactiveFormsModule, RouterModule, NgxValidateCoreModule, ...CORE_DIRECTIVES, ...CORE_PIPES, ...CORE_COMPONENTS],
      declarations: [],
      providers: [LocalizationPipe, provideHttpClient(withInterceptorsFromDi(), withFetch())]
    }]
  }], null, null);
...
_AbpApiDefinitionService.ɵfac = function AbpApiDefinitionService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AbpApiDefinitionService)();
};
...
//# sourceMappingURL=chunk-YNSF2OKM.js.map
