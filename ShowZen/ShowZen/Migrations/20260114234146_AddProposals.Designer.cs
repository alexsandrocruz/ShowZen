...
{
    [DbContext(typeof(ShowZenDbContext))]
    [Migration("20260114234146_AddProposals")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShowZen.Entities.Artists.Artist", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ProposalTemplateUrl")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ShowZen.Entities.Artists.ArtistSpecialty", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppArtistSpecialties", (string)null);
                });

            modelBuilder.Entity("ShowZen.Entities.Artists.Availability", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppAvailabilities", (string)null);
                });

            modelBuilder.Entity("ShowZen.Entities.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ShowZen.Entities.Clients.Client", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ShowZen.Entities.Events.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("LocalPartnerId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("LocationId")
                        .HasColumnType("uuid");

                    b.Property<int>("NegotiationType")
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("ProductionPercentage")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<Guid?>("SuggestedAlternativeArtistId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal?>("TicketPercentage")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("ArtistId", "StartDateTime");

                    b.ToTable("AppEvents", (string)null);
                });

            modelBuilder.Entity("ShowZen.Entities.Events.EventCommission", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppEventCommissions", (string)null);
                });

            modelBuilder.Entity("ShowZen.Entities.Events.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ShowZen.Entities.Proposals.Proposal", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppProposals", (string)null);
                });

            modelBuilder.Entity("ShowZen.Entities.Proposals.ProposalView", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppProposalViews", (string)null);
                });
            ...
            modelBuilder.Entity("ShowZen.Entities.Artists.ArtistSpecialty", b =>
                {
                    b.HasOne("ShowZen.Entities.Artists.Artist", "Artist")
            ...
            modelBuilder.Entity("ShowZen.Entities.Events.Event", b =>
                {
                    ...
                    b.HasOne("ShowZen.Entities.Clients.Client", "Client")
                        .WithMany()
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ShowZen.Entities.Clients.Client", "LocalPartner")
                        .WithMany()
                        .HasForeignKey("LocalPartnerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ShowZen.Entities.Events.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("ShowZen.Entities.Events.EventCommission", b =>
                {
                    b.HasOne("ShowZen.Entities.Events.Event", "Event")
            ...
            modelBuilder.Entity("ShowZen.Entities.Proposals.ProposalView", b =>
                {
                    b.HasOne("ShowZen.Entities.Proposals.Proposal", "Proposal")
                        .WithMany()
